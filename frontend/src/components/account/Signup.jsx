  ...
  return (
    <div className='container mx-auto px-3 xl:px-0'>
      <div className='sm:flex mt-3 lg:mt-11'>
        <div className='lg:flex-3 w-full sm:w-3/5 bg-no-repeat bg-cover bg-center rounded-xl relative order-1 sm:order-2' style={{ backgroundImage: `url(${images[index]})` }}>
        ...
        <div className='lg:flex-1 order-2 sm:order-1'>
          <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
            <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">Let's create your account</h2>
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                {/* <span className="text-sm font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline"> Forgot password? </span> */}
                            </div>
                            <div className="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
